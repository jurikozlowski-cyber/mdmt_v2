  ...
  try {
    ...
    for (let i = 1; i < rows.length; i++) {
      ...
      records.push({
        ...
        img2_prompt:  get(colMap.img2_prompt),
        link_pairs:   get(colMap.link_pairs),
        meta_title:   get(colMap.meta_title),
        meta_desc:    get(colMap.meta_desc),
        slug:         get(colMap.slug),
        photos:       get(colMap.photos) || '1',
